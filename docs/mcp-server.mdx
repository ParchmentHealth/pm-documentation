...
<Tabs>
  <Tab title="Claude Code">
    ...
    ```bash
    claude mcp add --transport http parchment-docs https://docs.parchment.health/mcp
    ```
    ...
    ```json
    {
      "mcpServers": {
        "parchment-docs": {
          "type": "http",
          "url": "https://docs.parchment.health/mcp"
        }
      }
    }
    ```
  ...
  <Tab title="Other">
    ...
    ```
    https://docs.parchment.health/mcp
    ```
...
For issues with the MCP server, contact support at [developer@parchment.health](mailto:developer@parchment.health).
