...
<CardGroup cols={2}>
  <Card title="Single Sign On" icon="shield-check" href="/sso/sso-introduction">
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="prescription"
    href="/api-reference/endpoint/v1/get-patient-prescriptions"
  >
    Learn how to read prescriptions for a patient
  </Card>
</CardGroup>
