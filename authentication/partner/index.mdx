...
This guide explains how to authenticate with the Parchment partner API. The partner authentication system uses a combination of API keys, client credentials, and JWT tokens to provide a secure and flexible authentication mechanism for partners.
