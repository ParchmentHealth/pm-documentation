...
4. **Scope of effect**: Removes all organization-level drugs. User-level drugs are not affected. To remove one drug use the per-item [org delete](/api-reference/endpoint/v1/delete-custom-drug-org).
