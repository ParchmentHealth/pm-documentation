...
4. **Scope of effect**: Only user-level drugs are removed here. For organization-level drugs use the per-item [org delete](/api-reference/endpoint/v1/delete-custom-drug-org) or the bulk delete endpoint.
